...
class MdFieldsMap:
    ...
    def products_src_map(cls) -> dict[str, str]:
        return {
            ...
            'Номенклатура или вид номенклатуры.Наименование': 'description',
            ...
            'Поставщик (WA).Код': 'supplier_code',
            ...
            'Характеристика номенклатуры.Пометка удаления': 'deletion_mark',
    ...
    def products_dest_map(cls) -> dict[str, Field]:
        return {
            ...
            'supplier_code': Field('supplier_code', 'character varying(200)'),
