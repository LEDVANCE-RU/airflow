...
class SiFieldsMap:
    ...
    def open_po_ic_src_map(cls) -> dict[str, str]:
        return {
            ...
            'Номенклатура.Наименование': 'description',
            ...
            'Заказ на поступление.Дата': 'po_date',
    ...
    def transit_src_map(cls) -> dict[str, str]:
        return {
            ...
            'Приходный ордер на товары.Дата': 'purchasing_doc_date',
            ...
            'Приходный ордер на товары.Проведен': 'posted',
            'Номенклатура.Артикул': 'ean',
            'Распоряжение.Number': 'po_number',
            'Распоряжение.Номер': 'po_number',
            'Распоряжение.Date': 'po_date',
            'Распоряжение.Дата': 'po_date',
            'Количество': 'po_qty',
        }
